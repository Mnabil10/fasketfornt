...
const ERROR_CODE_TRANSLATIONS: Record<string, string> = {
  ...
  CART_PRODUCT_OUT_OF_STOCK: "errors.CART_PRODUCT_OUT_OF_STOCK",
  CART_PROVIDER_UNAVAILABLE: "errors.CART_PROVIDER_UNAVAILABLE",
  DELIVERY_TERMS_NOT_ACCEPTED: "errors.DELIVERY_TERMS_NOT_ACCEPTED",
